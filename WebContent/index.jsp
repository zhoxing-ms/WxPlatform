...
wx.config({    
debug: false,    
appId: 'wx24776bc023d019e7',    
timestamp:'<%=session.getAttribute("timestamp")%>',    
nonceStr: '<%=session.getAttribute("nonce_str")%>',    
signature: '<%=session.getAttribute("signature")%>',
